...
class _Transfer(EnvExperiment):
    ...
    def test_bytes(self, large):
        for i in range(self.count):
            ...
            self.d2h[i] = self.core.mu_to_seconds(t1 - t0)
        return (self.h2d, self.d2h)

    @kernel
    def test_byte_list(self, large, count = 10):
        for i in range(self.count):
            t0 = self.core.get_rtio_counter_mu()
    ...
    @kernel
    def test_list(self, large, count = 10):
        for i in range(self.count):
            t0 = self.core.get_rtio_counter_mu()
    ...
    @kernel
    def test_array(self, large, count = 10):
        for i in range(self.count):
            t0 = self.core.get_rtio_counter_mu()
...
class TransferTest(ExperimentCase):
    ...
    def tearDownClass(self):
        ...
        for v in self.results:
            print("| {} | {:>12.2f} | {:>12.2f} |".format(pad(v[0]), v[1], v[2]))
